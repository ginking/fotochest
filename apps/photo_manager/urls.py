...
from photo_manager.views import homepage, photo, LocationsListView, slideshow, album, photo_download, AlbumListView, tag, PhotoLocationsListView, PhotoFullScreen, PhotoDetailView
